shinyUI(navbarPage("cricketr analyzes Cricketers!",
                   ...
                   tabPanel("IPL batsman",
                            titlePanel("Analyze IPL batsman"),
                   ...
                   tabPanel("IPL bowlers",
                            # Application title
                            titlePanel("Analyze IPL bowlers"),
                   ...
                   tabPanel("Head to head",
                            # Application title
                            titlePanel("Head-to-head between 2 IPL teams"),
                   ...
                   tabPanel("Overall Performance",
                            # Application title
                            titlePanel("Analyze IPL team's overall performance"),
